  ...
  queryWorkspace(queryStr) {
    ...
    for (const option of this.tokenGroupBlocks.parseTokens(query, 0, 0)) {
      ...
      if (!limited && query.resultCount >= WorkspaceQuerier.MAX_RESULTS) {
        /* eslint-disable */console.log(...oo_oo("963908404_1211_8_1211_78_4", "Warning: Workspace query exceeded maximum result count."));
        limited = true;
      }
      if (!query.canCreateMoreTokens()) {
        /* eslint-disable */console.log(...oo_oo("963908404_1216_8_1216_77_4", "Warning: Workspace query exceeded maximum token count."));
        limited = true;
        break;
      }
    }
