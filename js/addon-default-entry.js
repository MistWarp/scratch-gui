  ...
  queryWorkspace(queryStr) {
    ...
    for (const option of this.tokenGroupBlocks.parseTokens(query, 0, 0)) {
      ...
      if (Date.now() - startTime > MAX_EXECUTION_TIME) {
        /* eslint-disable */console.log(...oo_oo("2035097552_1228_8_1228_80_4", "Warning: Workspace query exceeded maximum execution time."));
        limited = true;
        break;
      }
      ...
      if (!limited && query.resultCount >= WorkspaceQuerier.MAX_RESULTS) {
        /* eslint-disable */console.log(...oo_oo("2035097552_1246_8_1246_78_4", "Warning: Workspace query exceeded maximum result count."));
        limited = true;
      }
      if (!query.canCreateMoreTokens()) {
        /* eslint-disable */console.log(...oo_oo("2035097552_1251_8_1251_77_4", "Warning: Workspace query exceeded maximum token count."));
        limited = true;
        break;
      }
    }
...
/* harmony default export */ __webpack_exports__["default"] = (async function (_ref) {
  ...
  try {
    if (!("colorIndex" in addon.tab.redux.state.scratchPaint.fillMode)) {
      /* eslint-disable */console.error(...oo_tx("3090226756_9_6_9_92_11", "Detected new paint editor; this will be supported in future versions."));
      return;
    }
  } catch (_) {
  ...
  const updateOnionLayers = async () => {
    ...
    try {
      ...
      /* eslint-disable */console.error(...oo_tx("3090226756_511_6_511_22_11", e));
    }
