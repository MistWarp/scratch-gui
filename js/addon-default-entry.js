...
/* harmony default export */ __webpack_exports__["default"] = (async _ref => {
  ...
  addon.tab.redux.addEventListener("statechanged", _ref2 => {
    ...
    // TODO vector support
    if (!Array.isArray(firstItem) || firstItem[0] !== "Raster") return /* eslint-disable */console.log(...oo_oo("2851621626_12_71_12_110_4", "copied element is vector"));
    const dataURL = firstItem[1].source;
    addon.tab.copyImage(dataURL).then(() => /* eslint-disable */console.log(...oo_oo("2851621626_16_18_16_58_4", "Image successfully copied"))).catch(e => /* eslint-disable */console.error(...oo_tx("2851621626_17_20_17_68_11", "Image could not be copied: ".concat(e))));
  });
});
  ...
  ScratchBlocks.Gesture.prototype.startDraggingBlock_ = function () {
    ...
    if (isDuplicating) {
      ...
      try {
        ...
        /* eslint-disable */console.error(...oo_tx("1435688330_79_8_79_24_11", e));
      }
...
; /* istanbul ignore next */
function oo_oo(/**@type{any}**/i) {
  for (var _len10 = arguments.length, v = new Array(_len10 > 1 ? _len10 - 1 : 0), _key10 = 1; _key10 < _len10; _key10++) {
    v[_key10 - 1] = arguments[_key10];
  }
  try {
    oo_cm().consoleLog(i, v);
  } catch (e) {}
...
; /* istanbul ignore next */
function oo_tr(/**@type{any}**/i) {
  for (var _len11 = arguments.length, v = new Array(_len11 > 1 ? _len11 - 1 : 0), _key11 = 1; _key11 < _len11; _key11++) {
    v[_key11 - 1] = arguments[_key11];
  }
  try {
    oo_cm().consoleTrace(i, v);
  } catch (e) {}
...
; /* istanbul ignore next */
function oo_tx(/**@type{any}**/i) {
  for (var _len12 = arguments.length, v = new Array(_len12 > 1 ? _len12 - 1 : 0), _key12 = 1; _key12 < _len12; _key12++) {
    v[_key12 - 1] = arguments[_key12];
  }
  try {
    oo_cm().consoleError(i, v);
  } catch (e) {}
  ...
  queryWorkspace(queryStr) {
    ...
    for (const option of this.tokenGroupBlocks.parseTokens(query, 0, 0)) {
      ...
      if (!limited && query.resultCount >= WorkspaceQuerier.MAX_RESULTS) {
        /* eslint-disable */console.log(...oo_oo("2513834380_1211_8_1211_78_4", "Warning: Workspace query exceeded maximum result count."));
        limited = true;
      }
      if (!query.canCreateMoreTokens()) {
        /* eslint-disable */console.log(...oo_oo("2513834380_1216_8_1216_77_4", "Warning: Workspace query exceeded maximum token count."));
        limited = true;
        break;
      }
    }
...
/* harmony default export */ __webpack_exports__["default"] = (async function (_ref) {
  ...
  try {
    if (!("colorIndex" in addon.tab.redux.state.scratchPaint.fillMode)) {
      /* eslint-disable */console.error(...oo_tx("3273213855_7_6_7_92_11", "Detected new paint editor; this will be supported in future versions."));
      return;
    }
  } catch (_) {
  ...
  const updateOnionLayers = async () => {
    ...
    try {
      ...
      /* eslint-disable */console.error(...oo_tx("3273213855_507_6_507_22_11", e));
    }
