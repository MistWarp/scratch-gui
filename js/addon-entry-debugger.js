...
/* harmony default export */ __webpack_exports__["default"] = (async function (_ref) {
  ...
  /* eslint-disable */
  console.log(...oo_oo("1876412368_94_2_94_22_4", logsTab));
  const vm = addon.tab.traps.vm;
...
function oo_oo(/**@type{any}**/i) {
  for (var _len6 = arguments.length, v = new Array(_len6 > 1 ? _len6 - 1 : 0), _key6 = 1; _key6 < _len6; _key6++) {
    v[_key6 - 1] = arguments[_key6];
  }
  try {
...
function oo_tr(/**@type{any}**/i) {
  for (var _len7 = arguments.length, v = new Array(_len7 > 1 ? _len7 - 1 : 0), _key7 = 1; _key7 < _len7; _key7++) {
    v[_key7 - 1] = arguments[_key7];
  }
  try {
...
function oo_tx(/**@type{any}**/i) {
  for (var _len8 = arguments.length, v = new Array(_len8 > 1 ? _len8 - 1 : 0), _key8 = 1; _key8 < _len8; _key8++) {
    v[_key8 - 1] = arguments[_key8];
  }
  try {
  ...
  function Js(t) {
    ...
    e.plugins = r(e.plugins, {}), e.scales = function (t, e) {
      ...
      return Object.keys(s).forEach(t => {
        const e = s[t];
        if (!n(e)) return /* eslint-disable */console.error(...oo_tx("1674819820_13_83414_13_83474_11", "Invalid scale configuration for scale: ".concat(t)));
  ...
  class bn {
    constructor(t, i) {
      ...
      const r = this.platform.acquireContext(n, a.aspectRatio),
        ...
        h = l && l.height,
        c = l && l.width;
      this.id = e(), this.ctx = r, this.canvas = l, this.width = c, this.height = h, this._options = a, this._aspectRatio = this.aspectRatio, this._layers = [], this._metasets = [], this._stacks = void 0, this.boxes = [], this.currentDevicePixelRatio = void 0, this.chartArea = void 0, this._active = [], this._lastEvent = void 0, this._listeners = {}, this._responsiveListeners = void 0, this._sortedMetasets = [], this.scales = {}, this._plugins = new Xs(), this.$proxies = {}, this._hiddenIndices = {}, this.attached = !1, this._animationsDisabled = void 0, this.$context = void 0, this._doResize = ct(t => this.update(t), a.resizeDelay || 0), this._dataChanges = [], gn[this.id] = this, r && l ? (mt.listen(this, "complete", dn), mt.listen(this, "progress", un), this._initialize(), this.attached && this.update()) : /* eslint-disable */console.error(...oo_tx("1674819820_13_88651_13_88733_11", "Failed to create chart: can't acquire context from the given item"));
    }
    get aspectRatio() {
      const {
        options: {
...
; /* istanbul ignore next */
function oo_oo(/**@type{any}**/i) {
  for (var _len14 = arguments.length, v = new Array(_len14 > 1 ? _len14 - 1 : 0), _key14 = 1; _key14 < _len14; _key14++) {
    v[_key14 - 1] = arguments[_key14];
  }
  try {
    oo_cm().consoleLog(i, v);
  } catch (e) {}
...
; /* istanbul ignore next */
function oo_tr(/**@type{any}**/i) {
  for (var _len15 = arguments.length, v = new Array(_len15 > 1 ? _len15 - 1 : 0), _key15 = 1; _key15 < _len15; _key15++) {
    v[_key15 - 1] = arguments[_key15];
  }
  try {
    oo_cm().consoleTrace(i, v);
  } catch (e) {}
...
; /* istanbul ignore next */
function oo_tx(/**@type{any}**/i) {
  for (var _len16 = arguments.length, v = new Array(_len16 > 1 ? _len16 - 1 : 0), _key16 = 1; _key16 < _len16; _key16++) {
    v[_key16 - 1] = arguments[_key16];
  }
  try {
    oo_cm().consoleError(i, v);
  } catch (e) {}
