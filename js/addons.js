      ...
      callback = files => {
        ...
        document.body.appendChild = fileInput => {
          ...
          if (fileInput instanceof HTMLInputElement) {
            ...
            /* eslint-disable */
            console.error(...oo_tx("634381932_107_12_107_104_11", 'File input was not immediately given to appendChild upon clicking "Import"!'));
...
const gotAudioEngine = audioEngine => {
  if (!audioEngine) {
    /* eslint-disable */console.error(...oo_tx("1487967918_49_4_49_83_11", 'could not get audio engine; sound-related addons will not work'));
    return;
  }
        ...
        for (const {
          ...
          if (injectMenu) {
            try {
              ...
              /* eslint-disable */console.error(...oo_tx("4019700028_579_28_579_91_11", 'Error while calling context menu callback: ', e));
            }
          }
        }
