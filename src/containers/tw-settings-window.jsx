...
import SettingsContent from '../components/tw-settings-modal/settings-content.jsx';
...
class SettingsWindow extends React.Component {
    ...
    componentDidUpdate(prevProps) {
        ...
        // Re-render content when props change
        if (this.settingsWindow && this.props.visible) {
            const contentContainer = this.settingsWindow.getContentElement();
            if (contentContainer) {
                this.renderSettingsContent(contentContainer);
            }
        }
    }
    ...
    createWindow() {
        ...
        this.settingsWindow.setContent(contentContainer);
        
        // Render React component inside the window
        this.renderSettingsContent(contentContainer);
    }
    
    renderSettingsContent(container) {        
        const settingsElement = React.createElement(SettingsContent, {
            ...this.getSettingsProps()
        });
        ...
        ReactDOM.render(settingsElement, container);
    }
    ...
    getSettingsProps() {
        ...
        return {
            ...
            // Pass through all the needed props from Redux state
            framerate: this.props.framerate,
            highQualityPen: this.props.highQualityPen,
            interpolation: this.props.interpolation,
            infiniteClones: this.props.infiniteClones,
            removeFencing: this.props.removeFencing,
            removeLimits: this.props.removeLimits,
            warpTimer: this.props.warpTimer,
            disableCompiler: this.props.disableCompiler,
            caseSensitiveLists: this.props.caseSensitiveLists,
            unsafeOptimisations: this.props.unsafeOptimisations,
    ...
    render () {
        ...
        // The window is managed through the WindowManager
        return null;
    }
}
...
const mapStateToProps = state => ({
    ...
    visible: state.scratchGui.modals.settingsModal
});
