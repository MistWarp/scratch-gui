...
const loadWorkspace = (ScratchBlocks, workspace, data, callbacks, allowDeferred = true) => {
    ...
    const useDeferredLoad = allowDeferred && xml.clearWorkspaceAndLoadFromXmlDeferred &&
